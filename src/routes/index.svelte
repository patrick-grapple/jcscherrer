<script lang="ts">
      ...
      props: {
        ...
        schema: {
          ...
          "field-properties": {
            ...
            "hidden-fields": ["id", "token", "trainingType"],
            "date-fields": [
              {
                name: "datum",
                type: "date",
  ...
  let isQueryExist = false;

  onMount(async () => {
    const urlSearchParams = new URLSearchParams(window.location.search);
    let token = urlSearchParams.get("token") || localStorage.getItem("token");
...
<div class={!isQueryExist ? "hidden" : ""} id="calendar" />
